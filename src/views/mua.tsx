...
class View extends Component {
  render({}, {envelopeOpen = false}) {
    return <>
      ...
      <div class="h-full overflow-hidden"><div class="flex flex-row flex-wrap md:flex-nowrap w-full overflow-hidden">
        <div role="sidebar" id="sidebar" class="m-4 flex flex-col w-48 overflow-y-auto overflow-x-hidden">
          <div role="section" aria-label="All inboxes" class="contents">
            <Button class="mr-2 w-full" primary filled static flex>
              <InlineIcon icon="carbon:list-boxes" /> Dashboard
            </Button>
            <Button class="mr-2 w-full" flex>
        ...
        <div class="max-w-sm last:max-w-none m-4 mr-0 last:mr-4 rounded-l-lg last:rounded-lg flex flex-row flex-grow bg-scheme-2 text-onscheme-2 overflow-clip overflow-y-auto overflow-x-hidden">
        ...
        {envelopeOpen ? <div class="+envelope w-auto m-4 ml-0 rounded-r-lg block flex-grow bg-scheme-2 text-onscheme-2 border-l-[1px] border-solid border-onscheme-2/10 overflow-auto">
          <div class="+sender p-4 border-b-[1px] border-solid border-onscheme-2/10 sticky bg-scheme-2 top-0">
          ...
          <div class="+content p-4 prose dark:prose-invert m-auto">
            <h1>Hello world!</h1>
